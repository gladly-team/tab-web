...
describe('SearchbarSFACSellNotification component', () => {
  it('renders without error', () => {
    const SearchbarSFACSellNotification =
      require('src/components/SearchbarSFACSellNotification').default
    const mockProps = getMockProps()
    expect(() => {
      shallow(<SearchbarSFACSellNotification {...mockProps} />)
    }).not.toThrow()
  })
  ...
  it('calls mutation, calls handler and closes on clicking no', () => {
    const SearchbarSFACSellNotification =
      require('src/components/SearchbarSFACSellNotification').default
    const mockProps = getMockProps()
    const wrapper = mount(<SearchbarSFACSellNotification {...mockProps} />)
