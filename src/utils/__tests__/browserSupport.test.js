...
describe('isTabExtensionSupported', () => {
  it('returns true on Chrome', () => {
    expect(isTabExtensionSupported(CHROME_BROWSER)).toEqual(true)
  })

  it('returns true on Edge', () => {
    expect(isTabExtensionSupported(EDGE_BROWSER)).toEqual(true)
  })

  it('returns false on Firefox', () => {
    expect(isTabExtensionSupported(FIREFOX_BROWSER)).toEqual(false)
  })

  it('returns false on Opera', () => {
    expect(isTabExtensionSupported(OPERA_BROWSER)).toEqual(false)
  })

  it('returns true on Safari', () => {
    expect(isTabExtensionSupported(SAFARI_BROWSER)).toEqual(true)
  })
